...
## Project Structure
    ...
    ├── testapiautoconnect_109669  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_109669`
...
2. Clone this repo and `cd testapiautoconnect_109669`
